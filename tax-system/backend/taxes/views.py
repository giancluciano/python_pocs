...
PRODUCTS = [
    {"name": "Laptop", "category": "Electronics", "basePrice": 999.99, "taxes": ["vat", "sales", "import"]},
    {"name": "Organic Coffee (1kg)", "category": "Food & Beverage", "basePrice": 24.50, "taxes": ["vat", "sales"]},
    {"name": "Designer Handbag", "category": "Luxury Goods", "basePrice": 1250.00, "taxes": ["vat", "sales", "luxury", "import"]},
    {"name": "Soda Pack (12 cans)", "category": "Food & Beverage", "basePrice": 6.99, "taxes": ["vat", "sales", "sugar"]},
    {"name": "Electric Scooter", "category": "Transport", "basePrice": 450.00, "taxes": ["vat", "sales", "eco"]},
    {"name": "Smartphone", "category": "Electronics", "basePrice": 799.00, "taxes": ["vat", "sales", "import"]},
    {"name": "Swiss Watch", "category": "Luxury Goods", "basePrice": 3500.00, "taxes": ["vat", "sales", "luxury", "import"]},
    {"name": "Running Shoes", "category": "Apparel", "basePrice": 120.00, "taxes": ["vat", "sales"]},
]
...
def catalog(_request):
    return JsonResponse({
        ...
        "years": YEARS,
        "taxNames": TAX_NAMES,
        "taxRates": TAX_RATES_BY_STATE_YEAR,
        "products": PRODUCTS,
    })
